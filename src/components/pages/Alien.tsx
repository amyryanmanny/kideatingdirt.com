...
export default function AlienPage() {
  return (
    <Page title="alien conspiracy">
      <p>The story must be told.</p>
      <p>The year was 1947. The date was TONIGHT! An alien spaceship touched down near Roswell, New Mexico.</p>
      <p>Although the government tried to cover up the incident, there were many witnesses. They haven't been able to tell their stories because of various government laws, but these don't apply to Kideatingdirt.com for some reason.</p>
      <pre>
